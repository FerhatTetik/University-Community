...
namespace UniversityCommunity.Data.EntityFramework
{
    public class UniversityCommunityContext : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer("server=FERHAT\\SQLEXPRESS;database=UniversityCommunity; integrated security=true;TrustServerCertificate=True;");
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<User>().Property(p => p.Status).HasDefaultValue(0);
